...
export default{
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <h1 style="color: black; margin: 1%; text-align: center;"> PEOPLE YOU FOLLOW</h1>
    ...
    computed:{
        username_array(){
            const usernames = [];
            this.followed_array.forEach(user => {
    ...
    mounted(){
//------------------Request1----------------------------------------------------
            const request1= fetchfunction(`${url}/api/following`,{
                method:"GET",
            },true)
            request1.then((data)=>{
                this.followed_array=data;
